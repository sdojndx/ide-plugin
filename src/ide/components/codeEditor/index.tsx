  ...
  return <div className='code_editor'>
    <div className='code_nav'>
      <div className='code_nav_l'>
        ...
        {codeOptionContent || <div className='code_op'>
          {codeOptionContent}
    ...
    <div className='editor_ls' >
      {ideFileTabs.map((editor) => (<CodeMirrorEditor style={{ display: editor.isVisible ? 'block' : 'none' }} className='editor_item' key={editor.id} editor={editor} />))}
    </div>
  </div>;
}
